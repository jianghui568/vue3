        ...
        <div class="box">
            <div class="login-content-left">
                ...
                <div class="login-content-left-mask">
                    <div>{{ $t('message.system.title') }}</div>
            ...
            <div class="box-inner">
                ...
                <el-form class="form">
                    <el-input size="large" v-model="form.name" :placeholder="$t('message.system.userName')" type="text"
                        maxlength="50">
                        <template #prepend>
                    ...
                    <el-input size="large" ref="password" v-model="form.password" :type="passwordType"
                        :placeholder="$t('message.system.password')" name="password" maxlength="50">
                        <template #prepend>
                    ...
                    <el-button type="primary" :loading="form.loading" @click="submit" style="width: 100%;"
                        size="medium">
...
import SelectLang from '../layout/select-lang.vue';
